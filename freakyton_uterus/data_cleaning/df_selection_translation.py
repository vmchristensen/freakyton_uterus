...
# Load the dataset
file_path = os.path.join(DATA_DIR, "IQ_Cancer_Endometrio_merged_NMS.csv")
...
df_relevant.to_csv(os.path.join(DATA_DIR, "IQ_Cancer_Endometrio_merged_NMS_relevant_english.csv"), index=False)
